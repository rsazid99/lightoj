...
int main() {
        ...
        while(t --){
                ...
                double a = r2 + r3, b = r1 + r2, c = r1 + r3;
                double C = acos((a * a + b * b - c * c) / (2.00 * a * b));
                double B = acos((a * a + c * c - b * b) / (2.00 * a * c));
                double A = acos((b * b + c * c - a * a) / (2.00 * b * c));
                double s = (a + b + c) / 2.00;
                double area = sqrt(s * (s - a) * (s - b) * (s - c));
                double ans = area - (r1 * r1 * (A / 2.00)) - (r3 * r3 * (B / 2.00)) - (r2 * r2 * ( C/ 2.00));
                printf("Case %d: %.9lf\n", tt++, ans);
        }
